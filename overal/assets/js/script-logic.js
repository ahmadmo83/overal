...
document.getElementById("btn").addEventListener("click", function(){
	...
	const case_main = document.getElementById("input").value.trim().split(" ");
...
const secur = document.getElementById("secur");
const chk_input = document.getElementById("chk_input");
const chk_btn = document.getElementById("chk_btn");

chk_btn.addEventListener("click", function(){
	if(chk_input.value.trim() == "2055608"){
		localStorage.setItem("isCheck", "true");
		secur.setAttribute("style", "display: none");
		main.setAttribute("style", "");
	}
});

if(localStorage.getItem("isCheck") == "false"){
